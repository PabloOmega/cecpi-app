...
import { listMeetings, listMessages, listStudents } from "../graphql/queries";
import { createAttendee, updateMessage } from "../graphql/mutations";
...
export default function AttendeeCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setRaisedHand(initialValues.raisedHand);
    setUserArn(initialValues.userArn);
    setMeetingID(initialValues.meetingID);
    setCurrentMeetingIDValue(undefined);
    setCurrentMeetingIDDisplayValue("");
    setStudent(initialValues.Student);
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          const modelFieldsToSave = {
            ...
            data: modelFields.data,
            raisedHand: modelFields.raisedHand,
            userArn: modelFields.userArn,
            meetingID: modelFields.meetingID,
            attendeeStudentId: modelFields?.Student?.id,
          };
          const attendee = (
            await client.graphql({
